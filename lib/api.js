import { IMAGE_MEDIAITEM } from "./fragments";

const API_URL = process.env.WORDPRESS_API_URL;

export const PROJECT_FC_TEXTBLOCK = "Projectfields_FlexibleContent_TextBlock";
export const PROJECT_FC_QUOTEBLOCK =
  "Projectfields_FlexibleContent_PullQuoteBlock";
export const PROJECT_FC_IMAGEBLOCK =
  "Projectfields_FlexibleContent_MainImageBlock";
